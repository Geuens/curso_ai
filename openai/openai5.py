...
client = OpenAI(api_key="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")
...
<profesor> La paciencia, bro, es aguantarse la movida sin flipar. Es como, "tranqui,
...
<alumno> Enséñame sobre la inteligencia artificial
"""
prompt = f"""
