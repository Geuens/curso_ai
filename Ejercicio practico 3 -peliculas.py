...
def mostrar_peliculas(lista_peliculas):
    ...
    for pelicula in lista_peliculas:
        print(pelicula)
        print(lista_peliculas[pelicula])
...
def modificar_presupuesto(lista_peliculas):

    porcentaje = input("\nIngrese el porcentaje a a modificar: ")

    for nombre in lista_peliculas:
        nuevo_presupuesto = float((lista_peliculas[nombre]["Presupuesto"])) * (1 + porcentaje / 100)
        lista_peliculas[nombre]["Presupuesto"] = max(nuevo_presupuesto, 0)
...
while (1):
    ...
    if opcion == '1':
        ...
        modificar_presupuesto(lista_peliculas)
    elif opcion == '7':
